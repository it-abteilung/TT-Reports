Report 50001 "TT Purchase - Quote RTC"
{
    // AC01 02.02.2022 DAP Item Charge Translations.
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/TT Purchase - Quote RTC.rdlc';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Resource_Name___Durchwahl2_Control1140114; Resource.Name + Durchwahl2)
                    {
                    }
                    ...
                    column(PreisAngebot; PreisAngebotLbl)
                    {
                    }
                    ...
                    column(PurchLine_Description4; PurchLine."Description 4")
                    {
                    }
                    column(PurchLine_Description5; PurchLine."Description 5")
                    {
                    }
                    column(PurchaseHeader_AngebotsabgabeBis; "Purchase Header"."Angebotsabgabe bis")
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Request_Date_; PurchLine."Requested Receipt Date")
                        {
                        }
    ...
    var
        ...
        Text003: label 'COPY';
        Text004: label 'Request for quotation %1';
        ...
        PreisAngebotLbl: label 'Please quote your best prices (per item) & earliest delivery time, latest by {0}';
        ...
        Pos_Caption_Control1140044Lbl: label 'Pos.';
