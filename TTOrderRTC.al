Report 50000 "TT Order RTC"
{
    // AC01 02.02.2022 DAP Item Charge Translations.
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/TT Order RTC.rdlc';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ElectronicInvoiceTxt; ElectronicInvoiceTxt)
                    {
                    }
                    ...
                    column(Resource_Name___Durchwahl2; Resource.Name + Durchwahl2)
                    {
                    }
                    ...
                    column(Betriebsstaette_Rotterdam; "Purchase Header"."Betriebsstätte Rotterdam")
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Text50001_________FORMAT__Purchase_Line___Requested_Receipt_Date__0_4____Text50003; Text50001 + ' ' + Format("Purchase Line"."Requested Receipt Date", 0, 4) + Text50003)
                        {
                        }
                        column(Purchase_Line_Request_Receipt_Date; "Purchase Line"."Requested Receipt Date")
                        {
                        }
                        ...
                        column(Bitte_vermerken_Sie_unbedingt_in_der_Rechnungsanschrift___Betriebsstaette_Rotterdam__Caption; Bitte_vermerken_Sie_unbedingt_in_der_Rechnungsanschrift___Betriebsstaette_Rotterdam__CaptionLbl)
                        {
                        }
                        column(sowie_in_der_Rechnung_unsere_niederlaendische_USt_Identnr__NL823384573B01Caption; sowie_in_der_Rechnung_unsere_niederlaendische_USt_Identnr__NL823384573B01CaptionLbl)
                        {
                        }
                        column(Rechnungen_ohne_diese_Angaben_koennen_nicht_akzeptiert_werdenCaption; Rechnungen_ohne_diese_Angaben_koennen_nicht_akzeptiert_werdenCaptionLbl)
                        {
                        }
                        ...
                        column(Item_Description3; Item_g."Description 3")
                        {
                        }
                        ...
                        begin
                            ...
                            if Job.Get("Purchase Header"."Job No.") then
                                if Job.ASME then
                                    if UnitofMeasureTranslation.Get("Purchase Line"."Unit of Measure", 'ENU') then
                                        "Purchase Line"."Unit of Measure" := UnitofMeasureTranslation.Description;
                            ...
                            */
                            ...
                            // G-ERP.RS 2020-02-12 +++ Anfrage#234852
                            Clear(Item_g);
                            if "Purchase Line".Type = "Purchase Line".Type::Item then begin
                                Item_g.Get("Purchase Line"."No.");
                            end;
                            // G-ERP.RS 2020-02-12 --- Anfrage#234852

                            // AC01 B
                            if "Purchase Line".Type = "Purchase Line".Type::"Charge (Item)" then begin
                                if ItemChargeTranslation.Get("Purchase Line"."No.", "Purchase Header"."Language Code") then
                                    "Purchase Line".Description := ItemChargeTranslation.Description;
                            end;
                            // AC01 E
            ...
            begin
                ...
                */
                ...
                if "Language Code" = 'ENU' then
                    AGBText := 'Those can be downloaded under https://turbotechnik.com/conditions/'
                else
                    AGBText := 'Jederzeit abrufbar unter https://turbotechnik.com/de/konditionen/';
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(Lieferadressedrucken; "Lieferadresse drucken")
                    {
                        ApplicationArea = Basic;
                    }
    ...
    var
        ...
        BITTE_BEACHTEN_CaptionLbl: label 'Description';
        ...
        Bitte_vermerken_Sie_unbedingt_in_der_Rechnungsanschrift___Betriebsstaette_Rotterdam__CaptionLbl: label 'Description';
        sowie_in_der_Rechnung_unsere_niederlaendische_USt_Identnr__NL823384573B01CaptionLbl: label 'Description';
        Rechnungen_ohne_diese_Angaben_koennen_nicht_akzeptiert_werdenCaptionLbl: label 'Description';
        ...
        EK_PreisCaptionLbl: label 'Direct Unit';
        Purchase_Line___Line_Discount___CaptionLbl: label '%';
        BetragCaptionLbl: label 'Amount';
        Pos_CaptionLbl: label 'Pos.';
        "ÜbertragCaptionLbl": label 'Continued';
        BetragCaption_Control1140037Lbl: label 'Amount';
        EmptyStringCaptionLbl: label '%';
        EK_PreisCaption_Control1140039Lbl: label 'Direct Unit Cost';
